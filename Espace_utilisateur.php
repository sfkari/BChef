...
if (!isset($_SESSION['utilisateur'])) {
    ...
    function getRecettes($connexion, $id_utilisateur) {
        try {
            $res = $connexion->prepare("SELECT DISTINCT recettes.* FROM recettes INNER JOIN favoris ON recettes.id_recette = favoris.id_recette WHERE favoris.id_utilisateur = ?");
    ...
    $recettes = getRecettes($connexion, $id_utilisateur);
}
?>
<main>
                ...
                <a href="recette.php?id_recette=<?php echo $recette['id_recette']; ?>">
                    <div class="card-block swiper-slide">
                        ...
                        <div class="card-content text-center">
                            <h2 class="name"><?php echo $recette['titre']; ?></h2>
