  ...
  <footer>
    <div class="container">
      <div class="row">
        <div class="col-md-12 d-flex justify-content-center py-5">
          <a href="index.html" class="d-inline-flex link-body-emphasis text-decoration-none ">
            <img src="./images/logo22.png" alt="logo" width="150px" data-aos="fade-in" data-aos-duration="3000">
          </a>
        </div>
      </div>
      <div class="row justify-content-center">
        <div class="col-md-7 text-center">
          <span data-aos="fade-in" data-aos-duration="5000">COMMUNAUTE</span>
          <h2 data-aos="fade-in" data-aos-duration="3000">Suivez nous sur les réseaux</h2>
          <p class="py-2 text-center" data-aos="fade-in" data-aos-duration="3000">Rejoignez-nous sur les réseaux sociaux pour partager, apprendre et grandir
            ensemble dans
      ...
      <div class="py-2" >
        ...
        <p>©2024 By SFA Karima · <a href="PrivacyTerms.php">Privacy & Terms</a> · <a href="FAQ.php">FAQs</a></p>
      </div>
    </div>
  </footer>
